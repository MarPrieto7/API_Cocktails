El proyecto IV es una página web que permite obtener información de diferentes tipos de cocktails a través de una API externa. Se exportan los datos en una tabla, que mostrará el nombre, y la imagen.<br>
